...
const ProgressAnalytics: React.FC<ProgressAnalyticsProps> = ({
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [trendsRes, heatmapRes, dnaRes, skillsRes, overviewRes] =
          await Promise.all([
            fetch(`${API_URL}/api/stats/trends`, {
              headers: { Authorization: `Bearer ${token}` },
            }),
            fetch(`${API_URL}/api/stats/heatmap`, {
              headers: { Authorization: `Bearer ${token}` },
            }),
            fetch(`${API_URL}/api/stats/dna`, {
              headers: { Authorization: `Bearer ${token}` },
            }),
            fetch(`${API_URL}/api/stats/skills`, {
              headers: { Authorization: `Bearer ${token}` },
            }),
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="text-5xl font-black text-[#30D8A8]">
                {avgScore}%
              </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="mt-4 flex items-center gap-2 text-white/40 text-xs font-bold">
                ...
                <span>
                  {overview?.marathons} Marathons · {overview?.sprints} Sprints
                </span>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-1">
                {overview?.strengths.map((s) => (
                  <div key={s} className="text-xl font-bold text-yellow-400">
                    {s}
                  </div>
                ))}
              </div>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-white/40 text-sm">
                Historical score progression based on interview verdicts.
              </p>
            </div>
          </div>
