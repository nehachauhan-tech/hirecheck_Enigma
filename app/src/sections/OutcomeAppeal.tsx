...
export const OutcomeAppeal: React.FC<OutcomeAppealProps> = ({
  onSumbit,
  status,
}) => {
      ...
      <div className="flex items-start gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-white/50">
            Did the measurement fail to capture your intent? Provide technical
            context below to trigger a human audit.
          </p>
        </div>
      </div>
      ...
      {status === "SUBMITTED" ? (
        ...
        >
          ...
          <p className="text-sm text-white/50 max-w-xs">
            Your technical context has been appended to the Master Report for
