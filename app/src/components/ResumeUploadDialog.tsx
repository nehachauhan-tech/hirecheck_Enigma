        ...
        try {
            ...
            if (res.ok) {
                toast({
                    ...
                    description: "Your interview questions will now be tailored to your experience.",
                });
                setOpen(false);
            } else {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button variant="outline" className="gap-2 border-[#30D8A8]/20 hover:border-[#30D8A8]/50 hover:bg-[#30D8A8]/5">
            ...
            <DialogContent className="sm:max-w-[600px] bg-[#0A0C10] border-white/10 text-white">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-white/50">
                        Paste your resume text here. The AI will read this to ask you relevant questions about your experience, past projects, and tech stack.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="flex justify-end gap-3">
                    <Button variant="ghost" onClick={() => setOpen(false)} className="text-white/60 hover:text-white hover:bg-white/5">
                        Cancel
                    </Button>
                    <Button onClick={handleSave} disabled={saving} className="bg-[#30D8A8] text-black hover:bg-[#20bd90]">
